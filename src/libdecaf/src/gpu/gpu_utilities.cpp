...
{
   static const auto DFT_NONE = DataFormatType::None;
   static const auto DFT_UINT = DataFormatType::UINT;
   static const auto DFT_FLOAT = DataFormatType::FLOAT;
   static const auto BADELEM = DataFormatElem{ 0, 0, 0 };
...
// TODO: This is actually deprecated once opengl_shader is refactored
uint32_t
